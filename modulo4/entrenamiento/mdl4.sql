...
-- Delete a teacher and observe the effect on the courses table (use of ON DELETE in FK).
...
-- Get students whose average grade is higher than the overall average (AVG() + subquery).
